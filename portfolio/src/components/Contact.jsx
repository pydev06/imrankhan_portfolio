    ...
    return (
        <section id="contact" className="py-32 px-8 md:px-16 lg:px-32 relative max-w-7xl mx-auto text-center overflow-hidden">
            ...
            <div className="bg-bg-panel/20 backdrop-blur-md p-12 md:p-24 panel-cut border border-white/5 relative group mb-32 shadow-[inset_0_0_40px_rgba(255,0,255,0.03)]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-1 hazard-stripes opacity-40 group-hover:opacity-100 transition-opacity" />
                ...
                <ScrollReveal delay={0.4} direction="up" width="100%">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 font-mono">
                        <a
                            href={`mailto:${email}`}
                            className="group/link flex flex-col items-center gap-4 p-8 border border-white/5 hover:border-accent-energon/50 transition-all bg-white/5 backdrop-blur-sm shadow-[inset_0_0_10px_rgba(255,0,255,0.02)]"
                        >
                            <div className="text-[10px] uppercase tracking-widest text-accent-energon font-black italic">COMMS_LINK</div>
                            <div className="text-sm text-text-muted group-hover/link:text-white transition-colors truncate w-full">{email}</div>
                            <div className="h-[1px] w-8 bg-accent-energon/30 group-hover/link:w-full transition-all duration-500 shadow-[0_0_5px_rgba(255,0,255,0.5)]" />
                        </a>
                        ...
                        <a
                            ...
                            className="group/link flex flex-col items-center gap-4 p-8 border border-white/5 hover:border-accent-hazard/50 transition-all bg-white/5 backdrop-blur-sm shadow-[inset_0_0_10px_rgba(204,255,0,0.02)]"
                        >
                            <div className="text-[10px] uppercase tracking-widest text-accent-hazard font-black italic">GITHUB_NODE</div>
                            <div className="text-lg text-text-muted group-hover/link:text-white transition-colors">/pydev06</div>
                            <div className="h-[1px] w-8 bg-accent-hazard/30 group-hover/link:w-full transition-all duration-500 shadow-[0_0_5px_rgba(204,255,0,0.5)]" />
                        </a>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group/link flex flex-col items-center gap-4 p-8 border border-white/5 hover:border-accent-core/50 transition-all bg-white/5 backdrop-blur-sm shadow-[inset_0_0_10px_rgba(14,165,233,0.02)]"
                        >
                            <div className="text-[10px] uppercase tracking-widest text-accent-core font-black italic">LINKEDIN_SIGNAL</div>
                            <div className="text-lg text-text-muted group-hover/link:text-white transition-colors">/imrankhan06</div>
                            <div className="h-[1px] w-8 bg-accent-core/30 group-hover/link:w-full transition-all duration-500 shadow-[0_0_5px_rgba(14,165,233,0.5)]" />
                        </a>
                        ...
                        >
                            ...
                            <div className="text-lg text-text-muted group-hover/link:text-white transition-colors">/i_am_rkstr</div>
                            <div className="h-[1px] w-8 bg-accent-energon/30 group-hover/link:w-full transition-all duration-500 shadow-[0_0_5px_rgba(255,0,255,0.5)]" />
                        </a>
                    </div>
                </ScrollReveal>
            ...
            <ScrollReveal delay={0.6} direction="up" width="100%">
                <div className="space-y-12">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 border-2 border-accent-hazard group-hover:inset-[-8px] transition-all duration-300 opacity-30 shadow-[0_0_30px_rgba(204,255,0,0.4)]" />
